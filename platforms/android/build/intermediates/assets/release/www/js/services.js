  ...
  .factory('Laporan', function($http) {
    return {
      getLaporan: function(laporan) {
        return $http.post('http://localhost/phplele/laporan.php')
  ...
  .factory('Detail', function($http) {
    return {
      getDetail: function(laporan) {
        return $http.post('http://localhost/phplele/detailLaporan.php')
        .success(function (data) {
          return data;
        }).error(function (err) {
            console.log('asaca');
...
.factory('CekKualitas', function($http,$q) {
  ...
  tambah: function (jenisKelamin,usia,berat,panjang){
        ...
        var link = 'http://localhost/phplele/cekKualitas.php';
